...
class VersionCacheBootstrapSpec extends SdkmanEnvSpecification {
	...
	static final CLI_VERSION_STABLE_ENDPOINT = "$CANDIDATES_API/broker/version/sdkman/script/stable"
	static final CLI_VERSION_BETA_ENDPOINT = "$CANDIDATES_API/broker/version/sdkman/script/beta"
